...
st.markdown("""
    ...
    /* تصغير خط الأزرار العلوية للشاشات والقوائم لتظهر بالكامل */
    .stButton>button {
...
# --- المحاسبة والشجرة والقوائم المالية الشاملة والكاملة ---
    ...
    # 7. حساب ضريبة القيمة المضافة مقسمة بالأرباع (الربع الأول، الثاني، الثالث، الرابع)
    with acc_tabs[6]:
